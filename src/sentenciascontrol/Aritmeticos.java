...
public class Aritmeticos extends javax.swing.JInternalFrame {
    ...
    private void bVerificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar1ActionPerformed
        try {
            ...
            boolean resp = mult.multiplo(n1, n2);
            if (resp) {
                JOptionPane.showMessageDialog(this, "Si es multiplo",
                        "RESULTADO",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "No es multiplo",
                        "RESULTADO",
                        JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    private void bCalcular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular2ActionPerformed
        try {
            ...
            int n3 = Integer.parseInt(tfNum5.getText());
            int n4 = Integer.parseInt(tfNum6.getText());
            int n5 = Integer.parseInt(tfNum7.getText());
            Calculos op = new Calculos();
            int resp = op.operacion(n1, n2, n3, n4, n5);
            String total = String.valueOf(resp);
            String mensaje = "El resultado es: " + total;
    ...
    private void bCalcular3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular3ActionPerformed
        try {
            int n1 = Integer.parseInt(tfNum8.getText());
            int n2 = Integer.parseInt(tfNum9.getText());
            int n3 = Integer.parseInt(tfNum10.getText());
            int n4 = Integer.parseInt(tfNum11.getText());
            int n5 = Integer.parseInt(tfNum12.getText());
            Calculos op = new Calculos();
            int resp = op.operacion2(n1, n2, n3, n4, n5);
            String total = String.valueOf(resp);
            String mensaje = "El resultado es: " + total;
            JOptionPane.showMessageDialog(this, mensaje,
                    "RESULTADO",
    ...
    private void bCalcular4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular4ActionPerformed
        try {
            ...
            double a = Integer.parseInt(tfNum14.getText());
            Calculos pow = new Calculos();
            double resp = pow.powerof(x, a);
            String total = String.valueOf(resp);
            String mensaje = "El resultado es: " + total;
            JOptionPane.showMessageDialog(this, mensaje,
                    "RESULTADO",
    ...
    private void bCalcular5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular5ActionPerformed
        try {
            ...
            double a = Integer.parseInt(tfNum16.getText());
            double b = Integer.parseInt(tfNum17.getText());
            Calculos pow = new Calculos();
            double resp = pow.powDivision(x, a, b);
            String total = String.valueOf(resp);
            String mensaje = "El resultado es: " + total;
            JOptionPane.showMessageDialog(this, mensaje,
                    "RESULTADO",
