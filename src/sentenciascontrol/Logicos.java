...
public class Logicos extends javax.swing.JInternalFrame {
    ...
    private void bCalcular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular2ActionPerformed
        // Calcular el mayor
        try {
            int n1 = Integer.parseInt(tfNum3.getText());
            int n2 = Integer.parseInt(tfNum4.getText());
            Logica op = new Logica();
            if (op.mayor_menor(n1, n2) == 1) {
                JOptionPane.showMessageDialog(this, "El primer numero es el mayor",
                        "RESULTADO",
                        JOptionPane.INFORMATION_MESSAGE);
            } else if (op.mayor_menor(n1, n2) == 2) {
                JOptionPane.showMessageDialog(this, "El segundo numero es el mayor",
                        "RESULTADO",
                        JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    private void bCalcular3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular3ActionPerformed
        // Calcular el menor
        try {
            int n1 = Integer.parseInt(tfNum5.getText());
            int n2 = Integer.parseInt(tfNum6.getText());
            Logica op = new Logica();
            if (op.mayor_menor(n1, n2) == 1) {
                JOptionPane.showMessageDialog(this, "El segundo numero es el menor",
                        "RESULTADO",
                        JOptionPane.INFORMATION_MESSAGE);
            } else if (op.mayor_menor(n1, n2) == 2) {
                JOptionPane.showMessageDialog(this, "El primer numero es el menor",
                        "RESULTADO",
                        JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    private void bCalcular4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular4ActionPerformed
        // si n1 >= n2 da verdad
        try {
            int n1 = Integer.parseInt(tfNum7.getText());
            int n2 = Integer.parseInt(tfNum8.getText());
            Logica op = new Logica();
            if (op.verdad1(n1, n2)) {
                ...
                JOptionPane.showMessageDialog(this, "Es falso",
                        "RESULTADO",
                        JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    private void bCalcular5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular5ActionPerformed
        // si n1 <= n2 da verdad
        try {
            int n1 = Integer.parseInt(tfNum9.getText());
            int n2 = Integer.parseInt(tfNum10.getText());
            Logica op = new Logica();
            if (op.verdad2(n1, n2)) {
                JOptionPane.showMessageDialog(this, "Es verdadero",
                        "RESULTADO",
    ...
    private void bVerificar6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar6ActionPerformed
        // Introduzca dos caracteres para verificar si son iguales
        char c1 = (tfCaracter1.getText()).charAt(0);
        char c2 = (tfCaracter2.getText()).charAt(0);
        Logica op = new Logica();
        if (op.caracteres(c1, c2)) {
            JOptionPane.showMessageDialog(this, "Son iguales",
                    "RESULTADO",
                    JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void bVerificar7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar7ActionPerformed
        // Introduzca dos caracteres para verficar si son diferentes
        char c1 = (tfCaracter3.getText()).charAt(0);
        char c2 = (tfCaracter4.getText()).charAt(0);
        Logica op = new Logica();
        if (op.caracteres(c1, c2) == false) {
            JOptionPane.showMessageDialog(this, "No son iguales",
                    "RESULTADO",
                    JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void bVerificar8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar8ActionPerformed
        // Introduzca dos cadenas de caracteres para verificar si son iguales
        String cad1 = tfCadena1.getText();
        String cad2 = tfCadena2.getText();
        Logica op = new Logica();
        if (op.cadenas(cad1, cad2)) {
            JOptionPane.showMessageDialog(this, "Son iguales",
                    "RESULTADO",
                    JOptionPane.INFORMATION_MESSAGE);
        } else {
    ...
    private void bCalcular9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular9ActionPerformed
        // Introduzca dos cadenas de caracteres para calcular la mayor
        String cad1 = tfCadena3.getText();
        String cad2 = tfCadena4.getText();
        Logica op = new Logica();
        if (op.cad_mayor(cad1, cad2) == 1) {
            JOptionPane.showMessageDialog(this, "La cadena 1 es mayor",
                    "RESULTADO",
                    JOptionPane.INFORMATION_MESSAGE);
        } else if (op.cad_mayor(cad1, cad2) == 2) {
            JOptionPane.showMessageDialog(this, "La cadena 2 es mayor",
                    "RESULTADO",
                    JOptionPane.INFORMATION_MESSAGE);
        } else {
    ...
    private void bVerificar10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar10ActionPerformed
        // Introduzca un número para verificar si es positivo o negativo
        try {
            int n1 = Integer.parseInt(tfNum11.getText());
            Logica op = new Logica();
            if (op.pos_neg(n1) == 1) {
                JOptionPane.showMessageDialog(this, "Es positivo",
                        "RESULTADO",
                        JOptionPane.INFORMATION_MESSAGE);
            } else if (op.pos_neg(n1) == -1) {
                JOptionPane.showMessageDialog(this, "Es negativo",
                        "RESULTADO",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Es cero",
                        "RESULTADO",
                        JOptionPane.INFORMATION_MESSAGE);
            }
